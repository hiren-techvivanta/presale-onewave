            ...
            <div className="position-absolute translate-centrt w-100 mw-100 px-3">
              <div className="login-box shadow-lg rounded-3 bg-white " style={{ maxWidth: "450px" }}>
                <div className="p-3 pb-0">
                  ...
                  <p className="text-secondary mb-4">Reset your password without any hassle</p>
                </div>
                <hr />
                ...
                <form className="px-3" >
                  ...
                  <p className="text-center mt-2 text-secondary pe-3 border-end">
                    <Link to={"/signin"} className="text-primary text-decoration-none fw-medium">Sign in </Link>
                  </p>
                  <p className="text-center mt-2 text-secondary"> <Link to="/signup" className="text-primary text-decoration-none fw-medium"> Sign Up</Link></p>
                  </div>
